...
const CONFIG = {
  ...
  // 難度設定（波次倍率 + AI 數值整合）
  difficulty: {
    x1: { label: '×1 普通', hpMult: 1, countMult: 1, aiHp: 100, aiBaseIncome: 50, aiStartGold: 300, aiTowerCost: 50, aiMaxTowers: 8 },
  ...
  activeElems: ["fire","water","earth","wind"],

  // 元素相剋
  elemAdv: {
    fire:  { water: 1.3, thunder: 0.7, wind: 0.7 },
    water:  { earth: 1.3, fire: 0.7 },
    earth:  { wind: 1.3, water: 0.7 },
    wind:  { thunder: 1.3, earth: 0.7, fire: 1.3 },
